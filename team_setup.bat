...
if not exist ".git" (
    ...
    git remote add origin https://github.com/yourusername/smart-attendance-system.git >nul 2>&1
...
echo.
echo Repository: https://github.com/yourusername/smart-attendance-system
echo.
pause