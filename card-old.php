...
<body>
    <div class="card-container">
        ...
        // QR Generation Functions for Student Card
        function generateStudentQR() {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    statusDiv.innerHTML = '<span style="color: #ff8c00; background: #fff3cd; padding: 8px; border-radius: 5px;">⚠️ Fallback QR Generated (Data still embedded)</span>';
                } else {
                    statusDiv.innerHTML = '<span style="color: #dc3545; background: #f8d7da; padding: 8px; border-radius: 5px;">❌ Generation failed: ' + (result.error || 'Unknown error') + '</span>';
                }
            } catch (error) {
